...
@section('content')
        ...
        <div class="flex items-stretch main-title">
            <div class="node">
                ...
                <div class="hgn-mt-line-cntr">
                    <div class="hgn-mt-line" style="  display: inline-block;
  width: 2px;
  height: 50%;
  ...
  left: 12px;
  top: 50%;
  background: linear-gradient(rgba(0, 200, 0, 0.3), rgba(0, 200, 0, 0.7));
...
"></div>
        ...
        <div id="contents">
            ...
            <div class="sub-network flex">
                ...
                <div class="mt-4">
                    <h2 class="text-2xl sub-title"><a href="#"><span class="node-ball"></span>クッキーの利用</a></h2>

                    <div style="max-width:calc(100vw - 150px);">
                        <p>
                            ...
                            <br>
                            <a href="#">HTTP cookie - Wikipedia</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="sub-network flex">
                ...
                <div class="mt-4">
                    <h2 class="text-2xl sub-title"><a href="#"><span class="node-ball"></span>メールアドレスの取得</a></h2>
        ...
        <div class="sub-network flex">
            ...
            <div class="mt-4">
                <h2 class="text-2xl sub-title"><a href="#"><span class="node-ball"></span>外部サービスのアカウント情報</a></h2>
        ...
        <div class="sub-network flex">
            ...
            <div class="mt-4">
                <h2 class="text-2xl sub-title"><span class="node-ball"></span>18禁ゲーム</h2>
                <div style="max-width:calc(100vw - 150px);">
                <p>
