...
Route::put('user/played_game/{game}', 'User\PlayedGameController@add')->middleware('auth');
Route::delete('user/played_game/{game}', 'User\PlayedGameController@remove')->middleware('auth');
