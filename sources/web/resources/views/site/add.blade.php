...
@section('content')
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div id="list_banner_text" class="form-group show_list_banner_upload show_list_banner_url">
            <p class="text-muted">
                ...
                <small class="show_list_banner_url">
                    画像サイズは最大468×60です。<br>
                    幅に合わせて自動で縮小されますが、高さが60pxを超えている分はカットされます。
                </small>
            </p>
            <div id="" class="list_site_banner_outline">
        ...
        <div id="detail_banner_text" class="form-group show_detail_banner_upload show_detail_banner_url">
            <p class="text-muted">
                ...
                <small class="show_detail_banner_url">
                    画像サイズは最大250×400です。<br>
                    幅に合わせて自動で縮小されますが、高さが400pxを超えている分はカットされます。
                </small>
            </p>
            <div id="" class="detail_site_banner_outline">
                <img src="" class="img-responsive" id="detail_banner_thumbnail">
            </div>
        </div>
    ...
    <script>
        $(function (){
            ...
            $('#detail_banner_url').change(function (){
                $('#detail_banner_thumbnail').attr('src', $(this).val());
            });
        });

        function changeUploadForm(target, flag)
        {
            $('#' + target + '_banner_thumbnail').attr('src', '');
        ...
        function changeUploadImage(target, file)
        {
            ...
            fd.onload = function() {
                $('#' + target + '_banner_thumbnail').attr('src', fd.result);
            };
