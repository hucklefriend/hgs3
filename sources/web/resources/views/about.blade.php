...
@section('content')
    ...
    <section class="my-5">
        <h2>同人や個人制作フリーゲームの扱い</h2>
        <p class="ml-3">
            今のところ、同人ゲームや個人制作のフリーゲームは登録していません。<br>
            将来的に制作者ご自身で登録できる機能を用意したいと思います。<br>
            同人ゲームであっても、メジャー/インディーズゲームとして移植しているタイトルは扱っています。<br>
            例：「ひぐらしのなく頃に」は最初の作品は同人なので扱っていませんが、PS2への移植版は扱っています。
        </p>
    </section>
