...
@section('content')
    ...
    <ul class="list-group no-border mb-5">
        ...
        <li class="list-group-item"><a href="{{ route('当サイトについて') }}">H.G.N.について</a></li>
    ...
    <ul class="list-group no-border">
        <li class="list-group-item"><a href="https://github.com/hucklefriend/hgs3" target="_blank">GitHubのH.G.N.プロジェクト</a></li>
    </ul>
@endsection
